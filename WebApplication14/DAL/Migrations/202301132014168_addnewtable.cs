namespace DAL.Migrations
{
    ...
    public partial class addnewtable : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        provideId = c.Int(nullable: false),
                        provide_ProviderId = c.Int(),
                    })
                .PrimaryKey(t => t.UserId)
                .ForeignKey("dbo.Providers", t => t.provide_ProviderId)
                .ForeignKey("dbo.Roles", t => t.RoleId, cascadeDelete: true)
                .Index(t => t.RoleId)
                .Index(t => t.provide_ProviderId);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Users", "provide_ProviderId", "dbo.Providers");
            DropForeignKey("dbo.Subscribes", "EventId", "dbo.Events");
            DropForeignKey("dbo.Events", "ProviderId", "dbo.Providers");
            DropIndex("dbo.Users", new[] { "provide_ProviderId" });
